...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:38:30   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly ITimeZone dal=DataAccess.CreateTimeZone();
		public TimeZone()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.TimeZone GetModelByCache(int TimeZoneID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.TimeZone)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.TimeZone> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.TimeZone> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.TimeZone> modelList = new List<KryptonAccessController.AccessDataBase.Model.TimeZone>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.TimeZone model;
