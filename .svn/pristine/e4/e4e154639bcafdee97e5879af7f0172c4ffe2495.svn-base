...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-09 11:42:24   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TimeStandardOperateProcedureGroup
	/// </summary>
	public partial class TimeStandardOperateProcedureGroup
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TimeSOPGID", "TimeStandardOperateProcedureGroup"); 
		}
		...
		public bool Exists(int TimeSOPGID)
		{
			...
			strSql.Append("select count(1) from TimeStandardOperateProcedureGroup");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TimeStandardOperateProcedureGroup(");
			strSql.Append("TimeSOPGID,TimeSOPGName,TimeSOPGEnable,TimeSOPGLoop,MonEnable,TueEnable,WedEnable,ThuEnable,FriEnable,SatEnable,SunEnable,TimePoint,SOPGroupID)");
			...
			parameters[12].Value = model.SOPGroupID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TimeStandardOperateProcedureGroup set ");
			...
			strSql.Append("SOPGroupID=@SOPGroupID");
			strSql.Append(" where TimeSOPGID=@TimeSOPGID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeSOPGName", SqlDbType.NVarChar,50),
					new SqlParameter("@TimeSOPGEnable", SqlDbType.Bit,1),
			...
			parameters[11].Value = model.SOPGroupID;
		...
		public bool Delete(int TimeSOPGID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TimeStandardOperateProcedureGroup ");
			strSql.Append(" where TimeSOPGID=@TimeSOPGID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeSOPGID", SqlDbType.Int,4)			};
			parameters[0].Value = TimeSOPGID;
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup GetModel(int TimeSOPGID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TimeSOPGID,TimeSOPGName,TimeSOPGEnable,TimeSOPGLoop,MonEnable,TueEnable,WedEnable,ThuEnable,FriEnable,SatEnable,SunEnable,TimePoint,SOPGroupID from TimeStandardOperateProcedureGroup ");
			strSql.Append(" where TimeSOPGID=@TimeSOPGID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeSOPGID", SqlDbType.Int,4)			};
			parameters[0].Value = TimeSOPGID;

			KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.TimeStandardOperateProcedureGroup();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select TimeSOPGID,TimeSOPGName,TimeSOPGEnable,TimeSOPGLoop,MonEnable,TueEnable,WedEnable,ThuEnable,FriEnable,SatEnable,SunEnable,TimePoint,SOPGroupID ");
			strSql.Append(" FROM TimeStandardOperateProcedureGroup ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TimeStandardOperateProcedureGroup T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TimeStandardOperateProcedureGroup";
