...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IEventSOP dal=DataAccess.CreateEventSOP();
		public EventSOP()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.EventSOP GetModelByCache(int EventSOPGID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.EventSOP)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.EventSOP> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.EventSOP> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.EventSOP> modelList = new List<KryptonAccessController.AccessDataBase.Model.EventSOP>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.EventSOP model;
