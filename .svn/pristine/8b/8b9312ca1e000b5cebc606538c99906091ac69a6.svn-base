...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:37:36   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly ITimeAccess dal=DataAccess.CreateTimeAccess();
		public TimeAccess()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.TimeAccess GetModelByCache(int TimeAccessID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.TimeAccess)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.TimeAccess> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.TimeAccess> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.TimeAccess> modelList = new List<KryptonAccessController.AccessDataBase.Model.TimeAccess>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.TimeAccess model;
