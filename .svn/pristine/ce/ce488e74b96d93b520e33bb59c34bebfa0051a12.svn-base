...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class EventCodeInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo GetModel(int EventCodeID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventCodeInfo();
			if (row != null)
			{
