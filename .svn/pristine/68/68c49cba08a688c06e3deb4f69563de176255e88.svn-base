...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class MediaVideoGroup
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup GetModel(int MediaVideoGroupID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup model=new KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup model=new KryptonAccessController.AccessSdkDataBase.Model.MediaVideoGroup();
			if (row != null)
			{
