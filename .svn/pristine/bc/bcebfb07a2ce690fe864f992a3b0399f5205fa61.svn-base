...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class EventInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.EventInfo GetModel(int EventID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.EventInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.EventInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.EventInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventInfo();
			if (row != null)
			{
