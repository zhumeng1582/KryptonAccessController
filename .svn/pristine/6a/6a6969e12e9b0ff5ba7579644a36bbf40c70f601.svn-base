...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class Menu
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.Menu GetModel(int MenuID,string MenuName)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.Menu model=new KryptonAccessController.AccessSdkDataBase.Model.Menu();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.Menu DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.Menu model=new KryptonAccessController.AccessSdkDataBase.Model.Menu();
			if (row != null)
			{
