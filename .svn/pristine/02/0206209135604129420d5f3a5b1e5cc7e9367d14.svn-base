...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ReaderTimeZone
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone GetModel(int ReaderTimeZoneID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeZone();
			if (row != null)
			{
