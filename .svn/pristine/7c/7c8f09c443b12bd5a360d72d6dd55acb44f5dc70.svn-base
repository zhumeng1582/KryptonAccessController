...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:31:30   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IControllerInfo dal=DataAccess.CreateControllerInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.ControllerInfo GetModelByCache(int ControllerID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.ControllerInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.ControllerInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.ControllerInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.ControllerInfo> modelList = new List<KryptonAccessController.AccessDataBase.Model.ControllerInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.ControllerInfo model;
