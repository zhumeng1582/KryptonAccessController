...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ManagerRightList
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList GetModel(int ManagerRightListID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList model=new KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList model=new KryptonAccessController.AccessSdkDataBase.Model.ManagerRightList();
			if (row != null)
			{
