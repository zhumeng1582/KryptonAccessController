...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:31:46   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	public partial class DoorUnitInfo
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.DoorUnitInfo GetModel(int DoorUnitID,int OutPutLockID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.DoorUnitInfo GetModelByCache(int DoorUnitID,int OutPutLockID)
		{
