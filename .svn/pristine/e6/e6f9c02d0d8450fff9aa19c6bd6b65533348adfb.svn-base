...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class UserGroup
	{
		...
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.UserGroup model)
		{
			...
			strSql.Append("UserGroupID,TimeAccessID)");
			...
			parameters[1].Value = model.TimeAccessID;
		...
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.UserGroup model)
		{
			...
			strSql.Append("TimeAccessID=@TimeAccessID");
			strSql.Append(" where UserGroupID=@UserGroupID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeAccessID", SqlDbType.Int,4),
					new SqlParameter("@UserGroupID", SqlDbType.Int,4)};
		...
		public KryptonAccessController.AccessSdkDataBase.Model.UserGroup GetModel(int UserGroupID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 UserGroupID,TimeAccessID from UserGroup ");
			strSql.Append(" where UserGroupID=@UserGroupID ");
			SqlParameter[] parameters = {
					new SqlParameter("@UserGroupID", SqlDbType.Int,4)			};
			parameters[0].Value = UserGroupID;

			KryptonAccessController.AccessSdkDataBase.Model.UserGroup model=new KryptonAccessController.AccessSdkDataBase.Model.UserGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.UserGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.UserGroup model=new KryptonAccessController.AccessSdkDataBase.Model.UserGroup();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserGroupID,TimeAccessID ");
