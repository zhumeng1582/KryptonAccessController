...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class InterLock
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.InterLock GetModel(int InterLockID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.InterLock model=new KryptonAccessController.AccessSdkDataBase.Model.InterLock();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.InterLock DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.InterLock model=new KryptonAccessController.AccessSdkDataBase.Model.InterLock();
			if (row != null)
			{
