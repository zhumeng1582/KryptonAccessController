...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IMediaVideo dal=DataAccess.CreateMediaVideo();
		public MediaVideo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.MediaVideo GetModelByCache(int MediaVideoID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.MediaVideo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.MediaVideo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.MediaVideo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.MediaVideo> modelList = new List<KryptonAccessController.AccessDataBase.Model.MediaVideo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.MediaVideo model;
