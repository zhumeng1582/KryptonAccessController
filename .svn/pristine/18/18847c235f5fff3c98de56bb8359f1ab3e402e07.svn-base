...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class StandardOperateProcedure
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure GetModel(int SOPID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure model=new KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure model=new KryptonAccessController.AccessSdkDataBase.Model.StandardOperateProcedure();
			if (row != null)
			{
