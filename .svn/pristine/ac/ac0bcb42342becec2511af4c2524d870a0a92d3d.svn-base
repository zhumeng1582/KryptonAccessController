...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ExpansionBoardInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo GetModel(int ExpansionBoardID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ExpansionBoardInfo();
			if (row != null)
			{
