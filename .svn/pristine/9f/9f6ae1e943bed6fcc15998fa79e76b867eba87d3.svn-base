	...
	public partial class ControllerInfo
	{
		...
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ControllerMAC", SqlDbType.NVarChar,12),
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo GetModel(int ControllerID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ControllerInfo();
			if (row != null)
			{
