...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:39:14   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.SQLServerDAL
{
	...
	public partial class UserInfo:IUserInfo
	{
		...
		public bool Add(KryptonAccessController.AccessDataBase.Model.UserInfo model)
		{
			...
			strSql.Append("UserID,UserName,Photograph,DepartmentID,EmployedDate,Duty,Telphone,Emai,UserGroupID1,UserGroupID2,UserGroupID3,UserGroupID4,FingerPosition0,FingerPrint0,FingerPosition1,FingerPrint1,SercurityAccessLevel,PrimaryCardID,SecondCardID)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Emai", SqlDbType.NVarChar,100),
		...
		public KryptonAccessController.AccessDataBase.Model.UserInfo GetModel(int UserID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 UserID,UserName,Photograph,DepartmentID,EmployedDate,Duty,Telphone,Emai,UserGroupID1,UserGroupID2,UserGroupID3,UserGroupID4,FingerPosition0,FingerPrint0,FingerPosition1,FingerPrint1,SercurityAccessLevel,PrimaryCardID,SecondCardID from UserInfo ");
			strSql.Append(" where UserID=@UserID ");
			SqlParameter[] parameters = {
					new SqlParameter("@UserID", SqlDbType.Int,4)			};
			parameters[0].Value = UserID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserID,UserName,Photograph,DepartmentID,EmployedDate,Duty,Telphone,Emai,UserGroupID1,UserGroupID2,UserGroupID3,UserGroupID4,FingerPosition0,FingerPrint0,FingerPosition1,FingerPrint1,SercurityAccessLevel,PrimaryCardID,SecondCardID ");
