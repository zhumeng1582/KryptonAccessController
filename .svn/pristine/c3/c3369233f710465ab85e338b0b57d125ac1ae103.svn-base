...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class TimeZone
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.TimeZone GetModel(int TimeZoneID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.TimeZone model=new KryptonAccessController.AccessSdkDataBase.Model.TimeZone();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.TimeZone DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.TimeZone model=new KryptonAccessController.AccessSdkDataBase.Model.TimeZone();
			if (row != null)
			{
