...
namespace KryptonAccessController.SQLite.BLL.InteractRelation
{
	...
	{
		private readonly KryptonAccessController.SQLite.DAL.InteractRelation.ControllerInfoInLAN dal=new KryptonAccessController.SQLite.DAL.InteractRelation.ControllerInfoInLAN();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN GetModelByCache(int ControllerID)
		{
			...
			return (KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN> modelList = new List<KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.SQLite.Model.InteractRelation.ControllerInfoInLAN model;
