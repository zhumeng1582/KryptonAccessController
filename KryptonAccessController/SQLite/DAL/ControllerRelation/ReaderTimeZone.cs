...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014/9/9 17:06:52   N/A    初版
*
...
namespace KryptonAccessController.SQLite.DAL.ControllerRelation
{
	...
	public partial class ReaderTimeZone
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("ReaderTimeZoneID", "ReaderTimeZone"); 
		}
		...
		public bool Exists(int ReaderTimeZoneID)
		{
			...
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeZoneID", DbType.Int32,4)			};
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ReaderTimeZone(");
			strSql.Append("ReaderTimeZoneID,TimeZone1,OperateMode1,TimeZone2,OperateMode2,TimeZone3,OperateMode3,TimeZone4,OperateMode4,TimeZone5,OperateMode5,TimeZone6,OperateMode6)");
			strSql.Append(" values (");
			strSql.Append("@ReaderTimeZoneID,@TimeZone1,@OperateMode1,@TimeZone2,@OperateMode2,@TimeZone3,@OperateMode3,@TimeZone4,@OperateMode4,@TimeZone5,@OperateMode5,@TimeZone6,@OperateMode6)");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeZoneID", DbType.Int32,4),
					new SQLiteParameter("@TimeZone1", DbType.String),
					new SQLiteParameter("@OperateMode1", DbType.Int32,4),
					new SQLiteParameter("@TimeZone2", DbType.String),
					new SQLiteParameter("@OperateMode2", DbType.Int32,4),
					new SQLiteParameter("@TimeZone3", DbType.String),
					new SQLiteParameter("@OperateMode3", DbType.Int32,4),
					new SQLiteParameter("@TimeZone4", DbType.String),
					new SQLiteParameter("@OperateMode4", DbType.Int32,4),
					new SQLiteParameter("@TimeZone5", DbType.String),
					new SQLiteParameter("@OperateMode5", DbType.Int32,4),
					new SQLiteParameter("@TimeZone6", DbType.String),
					new SQLiteParameter("@OperateMode6", DbType.Int32,4)};
			parameters[0].Value = model.ReaderTimeZoneID;
			parameters[1].Value = model.TimeZone1;
			parameters[2].Value = model.OperateMode1;
			parameters[3].Value = model.TimeZone2;
			parameters[4].Value = model.OperateMode2;
			parameters[5].Value = model.TimeZone3;
			parameters[6].Value = model.OperateMode3;
			parameters[7].Value = model.TimeZone4;
			parameters[8].Value = model.OperateMode4;
			parameters[9].Value = model.TimeZone5;
			parameters[10].Value = model.OperateMode5;
			parameters[11].Value = model.TimeZone6;
			parameters[12].Value = model.OperateMode6;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			SQLiteParameter[] parameters = {
					...
					new SQLiteParameter("@OperateMode6", DbType.Int32,4),
					new SQLiteParameter("@ReaderTimeZoneID", DbType.Int32,4)};
			parameters[0].Value = model.TimeZone1;
			parameters[1].Value = model.OperateMode1;
			parameters[2].Value = model.TimeZone2;
			parameters[3].Value = model.OperateMode2;
			parameters[4].Value = model.TimeZone3;
			parameters[5].Value = model.OperateMode3;
			parameters[6].Value = model.TimeZone4;
			parameters[7].Value = model.OperateMode4;
			parameters[8].Value = model.TimeZone5;
			parameters[9].Value = model.OperateMode5;
			parameters[10].Value = model.TimeZone6;
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone GetModel(int ReaderTimeZoneID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ReaderTimeZoneID,TimeZone1,OperateMode1,TimeZone2,OperateMode2,TimeZone3,OperateMode3,TimeZone4,OperateMode4,TimeZone5,OperateMode5,TimeZone6,OperateMode6 from ReaderTimeZone ");
			strSql.Append(" where ReaderTimeZoneID=@ReaderTimeZoneID ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeZoneID", DbType.Int32,4)			};
			parameters[0].Value = ReaderTimeZoneID;

			KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone model=new KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone DataRowToModel(DataRow row)
		{
			KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone model=new KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeZone();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ReaderTimeZoneID,TimeZone1,OperateMode1,TimeZone2,OperateMode2,TimeZone3,OperateMode3,TimeZone4,OperateMode4,TimeZone5,OperateMode5,TimeZone6,OperateMode6 ");
