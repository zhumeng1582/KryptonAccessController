...
namespace KryptonAccessController.SQLite.DAL.ControllerRelation
{
	...
	public partial class ReaderTimeAccess
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("ReaderTimeAccessID", "ReaderTimeAccess"); 
		}
		...
		public bool Exists(int ReaderTimeAccessID)
		{
			...
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeAccessID", DbType.Int32,4)			};
		...
		public bool Add(KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess model)
		{
			...
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeAccessID", DbType.Int32,4),
					new SQLiteParameter("@ReaderTimeAccessName", DbType.String),
		...
		public KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess GetModel(int ReaderTimeAccessID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ReaderTimeAccessID,ReaderTimeAccessName,Mon,Tue,Wed,Thu,Fri,Sat,Sun from ReaderTimeAccess ");
			strSql.Append(" where ReaderTimeAccessID=@ReaderTimeAccessID ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@ReaderTimeAccessID", DbType.Int32,4)			};
			parameters[0].Value = ReaderTimeAccessID;

			KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess model=new KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess DataRowToModel(DataRow row)
		{
			KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess model=new KryptonAccessController.SQLite.Model.ControllerRelation.ReaderTimeAccess();
			if (row != null)
			{
