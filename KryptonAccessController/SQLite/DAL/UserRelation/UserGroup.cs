...
namespace KryptonAccessController.SQLite.DAL.UserRelation
{
	...
	public partial class UserGroup
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("UserGroupID", "UserGroup"); 
		}
		...
		public KryptonAccessController.SQLite.Model.UserRelation.UserGroup GetModel(int UserGroupID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserGroupID,UserGroupName,UserGroupDes from UserGroup ");
			strSql.Append(" where UserGroupID=@UserGroupID ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@UserGroupID", DbType.Int32,4)			};
			parameters[0].Value = UserGroupID;

			KryptonAccessController.SQLite.Model.UserRelation.UserGroup model=new KryptonAccessController.SQLite.Model.UserRelation.UserGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.SQLite.Model.UserRelation.UserGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.SQLite.Model.UserRelation.UserGroup model=new KryptonAccessController.SQLite.Model.UserRelation.UserGroup();
			if (row != null)
			{
