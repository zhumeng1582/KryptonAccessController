...
namespace KryptonAccessController.SQLite.DAL.UserRelation
{
	...
	public partial class TimeZone
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("TimeZoneID", "TimeZone"); 
		}
		...
		public bool Exists(int TimeZoneID)
		{
			...
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@TimeZoneID", DbType.Int32,4)			};
		...
		public KryptonAccessController.SQLite.Model.UserRelation.TimeZone GetModel(int TimeZoneID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select TimeZoneID,STime1,ETime1,STime2,ETime2,STime3,ETime3,STime4,ETime4,STime5,ETime5,STime6,ETime6 from TimeZone ");
			strSql.Append(" where TimeZoneID=@TimeZoneID ");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@TimeZoneID", DbType.Int32,4)			};
			parameters[0].Value = TimeZoneID;

			KryptonAccessController.SQLite.Model.UserRelation.TimeZone model=new KryptonAccessController.SQLite.Model.UserRelation.TimeZone();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.SQLite.Model.UserRelation.TimeZone DataRowToModel(DataRow row)
		{
			KryptonAccessController.SQLite.Model.UserRelation.TimeZone model=new KryptonAccessController.SQLite.Model.UserRelation.TimeZone();
			if (row != null)
			{
