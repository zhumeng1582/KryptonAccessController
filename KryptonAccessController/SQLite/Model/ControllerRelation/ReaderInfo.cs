...
namespace KryptonAccessController.SQLite.Model.ControllerRelation
{
	...
	public partial class ReaderInfo
	{
		...
		/// 
		/// </summary>
		public int? SupervisedMode
		{
			set{ _supervisedmode=value;}
			get{return _supervisedmode;}
		}
		/// <summary>
		/// 
		/// </summary>
