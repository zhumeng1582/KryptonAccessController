...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly ICardInfo dal=DataAccess.CreateCardInfo();
		public CardInfo()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.CardInfo GetModelByCache(string CardID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.CardInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.CardInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.CardInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.CardInfo> modelList = new List<KryptonAccessController.AccessDataBase.Model.CardInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.CardInfo model;
