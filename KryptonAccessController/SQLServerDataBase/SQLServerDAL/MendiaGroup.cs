...
namespace KryptonAccessController.AccessDataBase.SQLServerDAL
{
	...
	/// 数据访问类:MendiaGroup
	/// </summary>
	public partial class MendiaGroup:IMendiaGroup
	{
		public MendiaGroup()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MendiaGroupID", "MendiaGroup"); 
		}
		...
		public bool Exists(int MendiaGroupID)
		{
			...
			strSql.Append("select count(1) from MendiaGroup");
		...
		public bool Delete(int MendiaGroupID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MendiaGroup ");
			strSql.Append(" where MendiaGroupID=@MendiaGroupID ");
			SqlParameter[] parameters = {
					new SqlParameter("@MendiaGroupID", SqlDbType.Int,4)			};
			parameters[0].Value = MendiaGroupID;
		...
		public bool DeleteList(string MendiaGroupIDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MendiaGroup ");
			strSql.Append(" where MendiaGroupID in ("+MendiaGroupIDlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MendiaGroupID,MendiaGroupName,MendiaGroupDes ");
			strSql.Append(" FROM MendiaGroup ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.MendiaGroupID desc");
			}
			strSql.Append(")AS Row, T.*  from MendiaGroup T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MendiaGroup";
			parameters[1].Value = "MendiaGroupID";
