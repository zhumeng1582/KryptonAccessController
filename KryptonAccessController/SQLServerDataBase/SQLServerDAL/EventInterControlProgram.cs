...
{
	/// <summary>
	/// 数据访问类:EventInterControlProgram
	/// </summary>
	public partial class EventInterControlProgram:IEventInterControlProgram
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("EventICPID", "EventInterControlProgram"); 
		}
		...
		public bool Exists(int EventICPID)
		{
			...
			strSql.Append("select count(1) from EventInterControlProgram");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into EventInterControlProgram(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EventInterControlProgram set ");
		...
		public bool Delete(int EventICPID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from EventInterControlProgram ");
			strSql.Append(" where EventICPID=@EventICPID ");
			SqlParameter[] parameters = {
					new SqlParameter("@EventICPID", SqlDbType.Int,4)			};
			parameters[0].Value = EventICPID;
		...
		public KryptonAccessController.AccessDataBase.Model.EventInterControlProgram GetModel(int EventICPID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 EventICPID,EventICPName,EventICPEnable,PointType,PointID,EventCodeID,ICPID from EventInterControlProgram ");
			strSql.Append(" where EventICPID=@EventICPID ");
			SqlParameter[] parameters = {
					new SqlParameter("@EventICPID", SqlDbType.Int,4)			};
			parameters[0].Value = EventICPID;

			KryptonAccessController.AccessDataBase.Model.EventInterControlProgram model=new KryptonAccessController.AccessDataBase.Model.EventInterControlProgram();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.EventInterControlProgram DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessDataBase.Model.EventInterControlProgram model=new KryptonAccessController.AccessDataBase.Model.EventInterControlProgram();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM EventInterControlProgram ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from EventInterControlProgram T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "EventInterControlProgram";
