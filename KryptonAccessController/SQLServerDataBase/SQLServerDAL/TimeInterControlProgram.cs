...
{
	/// <summary>
	/// 数据访问类:TimeInterControlProgram
	/// </summary>
	public partial class TimeInterControlProgram:ITimeInterControlProgram
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TimeICPID", "TimeInterControlProgram"); 
		}
		...
		public bool Exists(int TimeICPID)
		{
			...
			strSql.Append("select count(1) from TimeInterControlProgram");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TimeInterControlProgram(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TimeInterControlProgram set ");
		...
		public bool Delete(int TimeICPID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TimeInterControlProgram ");
			strSql.Append(" where TimeICPID=@TimeICPID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeICPID", SqlDbType.Int,4)			};
			parameters[0].Value = TimeICPID;
		...
		public KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram GetModel(int TimeICPID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TimeICPID,TimeICPName,TimeICPEnable,TimeICPLoop,MonEnable,TueEnable,WedEnable,ThuEnable,FriEnable,SatEnable,SunEnable,TimePoint,ICPID from TimeInterControlProgram ");
			strSql.Append(" where TimeICPID=@TimeICPID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeICPID", SqlDbType.Int,4)			};
			parameters[0].Value = TimeICPID;

			KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram model=new KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram model=new KryptonAccessController.AccessDataBase.Model.TimeInterControlProgram();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TimeInterControlProgram ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TimeInterControlProgram T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TimeInterControlProgram";
