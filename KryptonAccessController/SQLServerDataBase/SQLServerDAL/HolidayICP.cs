...
namespace KryptonAccessController.AccessDataBase.SQLServerDAL
{
	...
	/// 数据访问类:HolidayICP
	/// </summary>
	public partial class HolidayICP:IHolidayICP
	{
		public HolidayICP()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("HolidayID", "HolidayICP"); 
		}
		...
		public bool Update(KryptonAccessController.AccessDataBase.Model.HolidayICP model)
		{
			...
			parameters[4].Value = model.TimePoint;
		...
		public KryptonAccessController.AccessDataBase.Model.HolidayICP GetModel(int HolidayID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 HolidayID,HolidayName,HolidayStartDate,HolidayEndDate,HolidayType,TimePoint,ICPID from HolidayICP ");
			strSql.Append(" where HolidayID=@HolidayID ");
			SqlParameter[] parameters = {
					new SqlParameter("@HolidayID", SqlDbType.Int,4)			};
			parameters[0].Value = HolidayID;

			KryptonAccessController.AccessDataBase.Model.HolidayICP model=new KryptonAccessController.AccessDataBase.Model.HolidayICP();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.HolidayICP DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessDataBase.Model.HolidayICP model=new KryptonAccessController.AccessDataBase.Model.HolidayICP();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select HolidayID,HolidayName,HolidayStartDate,HolidayEndDate,HolidayType,TimePoint,ICPID ");
