...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:36:06   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.SQLServerDAL
{
	...
	public partial class PlayMediaInfo:IPlayMediaInfo
	{
		...
		public KryptonAccessController.AccessDataBase.Model.PlayMediaInfo GetModel(int PlayMediaID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 PlayMediaID,PlayMediaName,PlayReaderID,PlayLoop,PlayType1,PlayMediaGroupID1,STime1,ETime1,PlayType2,PlayMediaGroupID2,STime2,ETime2,PlayType3,PlayMediaGroupID3,STime3,ETime3,PlayType4,PlayMediaGroupID4,STime4,ETime4,PlayType5,PlayMediaGroupID5,STime5,ETime5,PlayType6,PlayMediaGroupID6,STime6,ETime6 from PlayMediaInfo ");
			strSql.Append(" where PlayMediaID=@PlayMediaID ");
			SqlParameter[] parameters = {
					new SqlParameter("@PlayMediaID", SqlDbType.Int,4)			};
			parameters[0].Value = PlayMediaID;
