...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IHolidaySOP dal=DataAccess.CreateHolidaySOP();
		public HolidaySOP()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.HolidaySOP GetModelByCache(int HolidayID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.HolidaySOP)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.HolidaySOP> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.HolidaySOP> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.HolidaySOP> modelList = new List<KryptonAccessController.AccessDataBase.Model.HolidaySOP>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.HolidaySOP model;
