...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:31:29   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly ICompanyInfo dal=DataAccess.CreateCompanyInfo();
		public CompanyInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.CompanyInfo GetModelByCache(int CompanyID)
		{
			
			string CacheKey = "CompanyInfoModel-" + CompanyID;
			...
			return (KryptonAccessController.AccessDataBase.Model.CompanyInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.CompanyInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.CompanyInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.CompanyInfo> modelList = new List<KryptonAccessController.AccessDataBase.Model.CompanyInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.CompanyInfo model;
