...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:31:32   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IDepartmentInfo dal=DataAccess.CreateDepartmentInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.DepartmentInfo GetModelByCache(int DepartmentID)
		{
			
			string CacheKey = "DepartmentInfoModel-" + DepartmentID;
			...
			return (KryptonAccessController.AccessDataBase.Model.DepartmentInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.DepartmentInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.DepartmentInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.DepartmentInfo> modelList = new List<KryptonAccessController.AccessDataBase.Model.DepartmentInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.DepartmentInfo model;
