...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014-04-18 16:31:27   N/A    初版
*
...
namespace KryptonAccessController.AccessDataBase.BLL
{
	...
	{
		private readonly IBlackListCardInfo dal=DataAccess.CreateBlackListCardInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessDataBase.Model.BlackListCardInfo GetModelByCache(string CardID)
		{
			...
			return (KryptonAccessController.AccessDataBase.Model.BlackListCardInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.BlackListCardInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessDataBase.Model.BlackListCardInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessDataBase.Model.BlackListCardInfo> modelList = new List<KryptonAccessController.AccessDataBase.Model.BlackListCardInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessDataBase.Model.BlackListCardInfo model;
