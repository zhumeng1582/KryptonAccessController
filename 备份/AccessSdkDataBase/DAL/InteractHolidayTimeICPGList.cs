...
{
	/// <summary>
	/// 数据访问类:InteractHolidayTimeICPGList
	/// </summary>
	public partial class InteractHolidayTimeICPGList
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ListID", "InteractHolidayTimeICPGList"); 
		}
		...
		public bool Exists(int ListID)
		{
			...
			strSql.Append("select count(1) from InteractHolidayTimeICPGList");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into InteractHolidayTimeICPGList(");
			strSql.Append("ListID,TimeICPGID,InteractHolidayID)");
			...
			parameters[1].Value = model.TimeICPGID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update InteractHolidayTimeICPGList set ");
			strSql.Append("TimeICPGID=@TimeICPGID,");
		...
		public bool Delete(int ListID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from InteractHolidayTimeICPGList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.Int,4)			};
			parameters[0].Value = ListID;
		...
		public KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList GetModel(int ListID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ListID,TimeICPGID,InteractHolidayID from InteractHolidayTimeICPGList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.Int,4)			};
			parameters[0].Value = ListID;

			KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList model=new KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList model=new KryptonAccessController.AccessSdkDataBase.Model.InteractHolidayTimeICPGList();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ListID,TimeICPGID,InteractHolidayID ");
			strSql.Append(" FROM InteractHolidayTimeICPGList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from InteractHolidayTimeICPGList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "InteractHolidayTimeICPGList";
