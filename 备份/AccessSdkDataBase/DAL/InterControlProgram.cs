...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class InterControlProgram
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram GetModel(int ICPID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram model=new KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram model=new KryptonAccessController.AccessSdkDataBase.Model.InterControlProgram();
			if (row != null)
			{
