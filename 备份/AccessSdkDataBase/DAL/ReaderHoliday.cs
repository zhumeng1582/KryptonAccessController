...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ReaderHoliday
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ReaderHoliday(");
			strSql.Append("ReaderHolidayID,ReaderHolidayName,ReaderHolidayType,ReaderHolidayDate,ReaderTimeZoneID)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ReaderHolidayDate", SqlDbType.NVarChar,10),
			...
			parameters[3].Value = model.ReaderHolidayDate;
			parameters[4].Value = model.ReaderTimeZoneID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append("ReaderHolidayDate=@ReaderHolidayDate,");
			strSql.Append("ReaderTimeZoneID=@ReaderTimeZoneID");
			strSql.Append(" where ReaderHolidayID=@ReaderHolidayID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ReaderHolidayName", SqlDbType.NVarChar,50),
					new SqlParameter("@ReaderHolidayType", SqlDbType.Int,4),
					...
					new SqlParameter("@ReaderTimeZoneID", SqlDbType.Int,4),
					new SqlParameter("@ReaderHolidayID", SqlDbType.Int,4)};
			parameters[0].Value = model.ReaderHolidayName;
			parameters[1].Value = model.ReaderHolidayType;
			parameters[2].Value = model.ReaderHolidayDate;
			parameters[3].Value = model.ReaderTimeZoneID;
			parameters[4].Value = model.ReaderHolidayID;
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday GetModel(int ReaderHolidayID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ReaderHolidayID,ReaderHolidayName,ReaderHolidayType,ReaderHolidayDate,ReaderTimeZoneID from ReaderHoliday ");
			strSql.Append(" where ReaderHolidayID=@ReaderHolidayID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ReaderHolidayID", SqlDbType.Int,4)			};
			parameters[0].Value = ReaderHolidayID;

			KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderHoliday();
			if (row != null)
			{
				...
				if(row["ReaderHolidayDate"]!=null)
				{
					model.ReaderHolidayDate=row["ReaderHolidayDate"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ReaderHolidayID,ReaderHolidayName,ReaderHolidayType,ReaderHolidayDate,ReaderTimeZoneID ");
