...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class CardInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.CardInfo GetModel(string CardID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.CardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.CardInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.CardInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.CardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.CardInfo();
			if (row != null)
			{
