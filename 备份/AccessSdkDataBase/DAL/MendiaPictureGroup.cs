...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class MendiaPictureGroup
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup GetModel(int MendiaPictureGroupID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.MendiaPictureGroup();
			if (row != null)
			{
