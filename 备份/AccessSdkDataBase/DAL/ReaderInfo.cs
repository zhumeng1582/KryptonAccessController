...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ReaderInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo GetModel(int ReaderID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderInfo();
			if (row != null)
			{
