...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class BlackListCardInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo GetModel(string CardID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo model=new KryptonAccessController.AccessSdkDataBase.Model.BlackListCardInfo();
			if (row != null)
			{
