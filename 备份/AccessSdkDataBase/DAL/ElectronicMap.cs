...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ElectronicMap
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap GetModel(int ElectronicMapID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap model=new KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap model=new KryptonAccessController.AccessSdkDataBase.Model.ElectronicMap();
			if (row != null)
			{
