...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class Holiday
	{
		...
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.Holiday model)
		{
			...
			strSql.Append("HolidayID,HolidayName,HolidayDate,HolidayType,TimeZoneID)");
			strSql.Append(" values (");
			strSql.Append("@HolidayID,@HolidayName,@HolidayDate,@HolidayType,@TimeZoneID)");
			SqlParameter[] parameters = {
					new SqlParameter("@HolidayID", SqlDbType.Int,4),
					new SqlParameter("@HolidayName", SqlDbType.NVarChar,50),
					new SqlParameter("@HolidayDate", SqlDbType.NVarChar,10),
			...
			parameters[4].Value = model.TimeZoneID;
		...
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.Holiday model)
		{
			...
			parameters[3].Value = model.TimeZoneID;
			parameters[4].Value = model.HolidayID;
		...
		public KryptonAccessController.AccessSdkDataBase.Model.Holiday GetModel(int HolidayID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 HolidayID,HolidayName,HolidayDate,HolidayType,TimeZoneID from Holiday ");
			strSql.Append(" where HolidayID=@HolidayID ");
			SqlParameter[] parameters = {
					new SqlParameter("@HolidayID", SqlDbType.Int,4)			};
			parameters[0].Value = HolidayID;

			KryptonAccessController.AccessSdkDataBase.Model.Holiday model=new KryptonAccessController.AccessSdkDataBase.Model.Holiday();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.Holiday DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.Holiday model=new KryptonAccessController.AccessSdkDataBase.Model.Holiday();
			if (row != null)
			{
				...
				{
					model.HolidayDate=row["HolidayDate"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select HolidayID,HolidayName,HolidayDate,HolidayType,TimeZoneID ");
