...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ReaderTimeAccess
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess GetModel(int ReaderTimeAccessID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess model=new KryptonAccessController.AccessSdkDataBase.Model.ReaderTimeAccess();
			if (row != null)
			{
