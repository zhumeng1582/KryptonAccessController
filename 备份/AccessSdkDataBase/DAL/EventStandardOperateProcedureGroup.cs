...
{
	/// <summary>
	/// 数据访问类:EventStandardOperateProcedureGroup
	/// </summary>
	public partial class EventStandardOperateProcedureGroup
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("EventSOPGID", "EventStandardOperateProcedureGroup"); 
		}
		...
		public bool Exists(int EventSOPGID)
		{
			...
			strSql.Append("select count(1) from EventStandardOperateProcedureGroup");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into EventStandardOperateProcedureGroup(");
			strSql.Append("EventSOPGID,EventSOPGName,EventSOPGEnable,PointType,PointID,EventCodeID,SOPGroupID)");
			...
			parameters[6].Value = model.SOPGroupID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[5].Value = model.SOPGroupID;
		...
		public bool Delete(int EventSOPGID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from EventStandardOperateProcedureGroup ");
			strSql.Append(" where EventSOPGID=@EventSOPGID ");
			SqlParameter[] parameters = {
					new SqlParameter("@EventSOPGID", SqlDbType.Int,4)			};
			parameters[0].Value = EventSOPGID;
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup GetModel(int EventSOPGID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 EventSOPGID,EventSOPGName,EventSOPGEnable,PointType,PointID,EventCodeID,SOPGroupID from EventStandardOperateProcedureGroup ");
			strSql.Append(" where EventSOPGID=@EventSOPGID ");
			SqlParameter[] parameters = {
					new SqlParameter("@EventSOPGID", SqlDbType.Int,4)			};
			parameters[0].Value = EventSOPGID;

			KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup model=new KryptonAccessController.AccessSdkDataBase.Model.EventStandardOperateProcedureGroup();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select EventSOPGID,EventSOPGName,EventSOPGEnable,PointType,PointID,EventCodeID,SOPGroupID ");
			strSql.Append(" FROM EventStandardOperateProcedureGroup ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from EventStandardOperateProcedureGroup T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "EventStandardOperateProcedureGroup";
