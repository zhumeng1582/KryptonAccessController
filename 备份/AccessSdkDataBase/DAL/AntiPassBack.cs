...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class AntiPassBack
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack GetModel(int AntiPassBackID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack model=new KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack model=new KryptonAccessController.AccessSdkDataBase.Model.AntiPassBack();
			if (row != null)
			{
