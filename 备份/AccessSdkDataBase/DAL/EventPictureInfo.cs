...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class EventPictureInfo
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo GetModel(int EventPictureID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo model=new KryptonAccessController.AccessSdkDataBase.Model.EventPictureInfo();
			if (row != null)
			{
