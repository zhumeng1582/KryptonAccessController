...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class TimeAccess
	{
		...
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.TimeAccess model)
		{
			...
			strSql.Append("TimeAccessID,Mon,Tue,Wed,Thu,Fri,Sat,Sun)");
		...
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.TimeAccess model)
		{
			...
			parameters[7].Value = model.TimeAccessID;
		...
		public KryptonAccessController.AccessSdkDataBase.Model.TimeAccess GetModel(int TimeAccessID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TimeAccessID,Mon,Tue,Wed,Thu,Fri,Sat,Sun from TimeAccess ");
			strSql.Append(" where TimeAccessID=@TimeAccessID ");
			SqlParameter[] parameters = {
					new SqlParameter("@TimeAccessID", SqlDbType.Int,4)			};
			parameters[0].Value = TimeAccessID;

			KryptonAccessController.AccessSdkDataBase.Model.TimeAccess model=new KryptonAccessController.AccessSdkDataBase.Model.TimeAccess();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.TimeAccess DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.TimeAccess model=new KryptonAccessController.AccessSdkDataBase.Model.TimeAccess();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select TimeAccessID,Mon,Tue,Wed,Thu,Fri,Sat,Sun ");
