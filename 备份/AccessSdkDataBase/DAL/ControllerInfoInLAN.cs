...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class ControllerInfoInLAN
	{
		...
		public KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN GetModel(int ControllerID)
		{
			...
			KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN model=new KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN model=new KryptonAccessController.AccessSdkDataBase.Model.ControllerInfoInLAN();
			if (row != null)
			{
