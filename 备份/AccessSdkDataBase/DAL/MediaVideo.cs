...
namespace KryptonAccessController.AccessSdkDataBase.DAL
{
	...
	public partial class MediaVideo
	{
		...
		public bool Add(KryptonAccessController.AccessSdkDataBase.Model.MediaVideo model)
		{
			...
			strSql.Append("MediaVideoID,MediaVideoFilePath,MediaVideoType)");
			...
			parameters[2].Value = model.MediaVideoType;
		...
		public bool Update(KryptonAccessController.AccessSdkDataBase.Model.MediaVideo model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@MediaVideoType", SqlDbType.Int,4),
					new SqlParameter("@MediaVideoID", SqlDbType.Int,4)};
			parameters[0].Value = model.MediaVideoFilePath;
			parameters[1].Value = model.MediaVideoType;
		...
		public KryptonAccessController.AccessSdkDataBase.Model.MediaVideo GetModel(int MediaVideoID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MediaVideoID,MediaVideoFilePath,MediaVideoType from MediaVideo ");
			strSql.Append(" where MediaVideoID=@MediaVideoID ");
			SqlParameter[] parameters = {
					new SqlParameter("@MediaVideoID", SqlDbType.Int,4)			};
			parameters[0].Value = MediaVideoID;

			KryptonAccessController.AccessSdkDataBase.Model.MediaVideo model=new KryptonAccessController.AccessSdkDataBase.Model.MediaVideo();
		...
		/// 得到一个对象实体
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.MediaVideo DataRowToModel(DataRow row)
		{
			KryptonAccessController.AccessSdkDataBase.Model.MediaVideo model=new KryptonAccessController.AccessSdkDataBase.Model.MediaVideo();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MediaVideoID,MediaVideoFilePath,MediaVideoType ");
