...
namespace KryptonAccessController.AccessSdkDataBase.BLL
{
	...
	{
		private readonly KryptonAccessController.AccessSdkDataBase.DAL.PlayMediaInfo dal=new KryptonAccessController.AccessSdkDataBase.DAL.PlayMediaInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo GetModelByCache(int PlayMediaID)
		{
			...
			return (KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo> DataTableToList(DataTable dt)
		{
			List<KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo> modelList = new List<KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KryptonAccessController.AccessSdkDataBase.Model.PlayMediaInfo model;
